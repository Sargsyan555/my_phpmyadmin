...
@section('content')
{{--inner table fild create--}}
<div id="page_content">
    <form method="post" action="table_create" class="create_table_form ajax lock-page">
        @csrf
        <input type="hidden" name="db_id" value="{{$table->token}}">
        <input type="hidden" name="table" value="{{$table->id}}">
        <input type="hidden" name="reload" value="1">
        <input type="hidden" name="orig_num_fields" value="{{$table->num_fields}}">
        <input type="hidden" name="orig_field_where" value="">
        <input type="hidden" name="orig_after_field" value="">
        <input type="hidden" name="token" value="{{$table->token}}">
        ...
        <div id="table_name_col_no_outer">
            <table id="table_name_col_no" class="pma-table tdblock" style="top: 55px;">
                <tbody>
                <tr class="align-middle float-start">
                    <form >
                        <input type="hidden" name="db" id="table_id" value="{{$table->id}}">

                        <td>Table name:
                            <input type="text" name="added_table" id="added_table" size="40" maxlength="64" value="{{$table->table}}" class="textfield" autofocus="" required="">
                        </td>
                        <td>
                            Add
                            <input type="number" id="added_fields" name="added_fields" size="2" value="1" min="1" onfocus="this.select()">
                            column(s)
                            <input class="btn btn-secondary" id="add_columns_in_table" type="button" name="submit_num_fields" value="Go">
                        </td>
                    </form>
                </tr>
                </tbody>
            ...
            <table id="table_columns" class="pma-table noclick">
                ...
                @for($i=0; $i<$table->num_fields; $i++)
                    ...
                    <td class="text-center">
                        <input id="field_3_1" type="text" name="field_name[{{$i}}]" maxlength="64" class="textfield" title="Column" size="10" value="">
                    </td>
                    <td class="text-center">
                        <select class="column_type" name="field_type[{{$i}}]" id="field_3_2">
                    ...
                    <td class="text-center">
                        <input id="field_3_3" type="text" name="field_length[{{$i}}]" size="8" value="" class="textfield">
                        <p class="enum_notice" id="enum_notice_3_3" style="display: none;">
                            <a href="#" class="open_enum_editor">Edit ENUM/SET values</a>
                        </p>
                    </td>
                    <td class="text-center">
                        <select name="field_default[{{$i}}]" id="field_3_4" class="default_type">
                            <option value="NONE">
                                None    </option>
                    ...
                    <td class="text-center">
                        <select lang="en" dir="ltr" name="field_collation[{{$i}}]" id="field_3_5">
                            <option value=""></option>
                    ...
                    <td class="text-center">
                        <select name="field_attribute[{{$i}}]" id="field_3_6">
                    ...
                    <td class="text-center">
                        <input name="field_null[{{$i}}]" id="field_3_7" type="checkbox" value="YES" class="allow_null">
                    </td>
                    <td class="text-center">
                        <select name="field_key[{{$i}}]" id="field_3_8" data-index="">
                    ...
                    <td class="text-center">
                        <input name="field_extra[{{$i}}]" id="field_3_9" type="checkbox" value="AUTO_INCREMENT">
                    </td>
                    <td class="text-center">
                        <textarea id="field_3_10" rows="1" name="field_comments[{{$i}}]" maxlength="1024"></textarea>
                    </td>
                    <td class="text-center">
                        <select name="field_virtuality[{{$i}}]" id="field_3_11" class="virtuality">
                            <option value="">
                        ...
                        <input type="text" name="field_expression[{{$i}}]" size="12" value="" placeholder="Expression" class="textfield expression" style="display: none;">
                    </td>

                    <td class="text-center">
                        <select id="field_3_12" name="field_move_to[{{$i}}]" size="1" width="5em">
